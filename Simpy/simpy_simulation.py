...
def truck(env, name, direction, intersection):
    ...
    print(f"Truck {name} from direction {direction} arrived at {arrival_time} time.")
    with intersection.request() as req: #truck requesting access to intersection.
        ...
        print(f"Truck {name} from direction {direction} departed at {departure_time:.2f} time.")
